document.addEventListener("DOMContentLoaded", () => {
    ...
    const sortButtonImg = sortButton.querySelector("img");
    sortOptions.addEventListener("transitionend", () => {
        if (sortOptions.classList.contains("visible")) {
            sortButtonImg.src = "/images/arrow-up-off.png";
        } else {
            sortButtonImg.src = "/images/arrow-down-off.png";
        }
    });

    const filterButtonImg = filterButton.querySelector("img");
    filterOptions.addEventListener("transitionend", () => {
        if (filterOptions.classList.contains("visible")) {
            filterButtonImg.src = "/images/close-off.png";
        } else {
            filterButtonImg.src = "/images/filter-off.png";
        }
    }
    );
